              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">
                    Email Address <span className="text-gray-400 normal-case font-normal text-[10px] ml-1">(cannot be changed here)</span>
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-2.5 bg-gray-100 border border-gray-200 rounded-xl text-gray-500 text-sm cursor-not-allowed outline-none opacity-80"
                    />
                  </div>
                </div>
                <div>
