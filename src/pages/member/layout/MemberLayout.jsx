...
const MemberLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Bookings', path: '/member/bookings', icon: CalendarCheck },
    { name: 'Attendance', path: '/member/attendance', icon: History },
    { name: 'Payments', path: '/member/payments', icon: CreditCard },
    { name: 'Workouts', path: '/member/workouts', icon: Dumbbell },
  ];
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 h-full">
        ...
        <div className="h-20 flex items-center gap-3 px-6 border-b border-gray-100">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-1">Babcock University</p>
          </div>
        </div>
